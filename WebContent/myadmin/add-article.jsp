			...
			<ul class="nav pull-right">
				...
				<li class="notification-dropdown hidden-phone"><a href="#"
					...
					<div class="pop-dialog">
						...
						<div class="body">
							<a href="#" class="close-icon"><i class="/myadmin/icon-remove-sign"></i></a>
							<div class="messages">
				...
				<div class="row-fluid form-wrapper">
					...
					<div class="span8 column">
						<form action="/articleadd" method="post">
							<div class="field-box">
								<label>文章标题:</label> <input name="articleName" class="span8"
									type="text" />
							</div>
							<!-- 						<div class="field-box"> -->
...
<%-- 								<c:forEach var="altype" items="${arraytype}"> --%>
<!-- 									<label class="checkbox"> <input name="articleType" type="checkbox" /> -->
<%-- 										${altype[1]} --%>
<!-- 										</label>									 -->
<!-- 										<label class="checkbox"> <input name="articleType" type="checkbox" /> -->
<%-- 										${altype[1]} --%>
